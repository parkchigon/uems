					...
					<colgroup>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select id="coolwater1_monthly_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
					...
					<colgroup>
						...
						<tbody>
							...
							<tr>
								...
								<th scope="row">월간 순시 열량</th>
								<td>
									<select id="coolwater2_monthly_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
					...
					<colgroup>
						...
						<tbody>
							...
							<tr>
								...
								<th scope="row">월간 순시 열량</th>
								<td>
									<select id="coolwater3_monthly_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">적산열량</th>
								<td>
									<select id="coolwater3_accum_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
			...
			<dl>
				...
				<dd>
					...
					<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">냉동기#1 가동시간 ON/OFF</th>
								<td>
								...
								<th scope="row">냉동기#2 가동시간 ON/OFF</th>
								<td>
								...
								<th scope="row">냉동기#3 가동시간 ON/OFF</th>
								<td>
							...
							<tr>
								<th scope="row">브라인#1 가동시간 ON/OFF</th>
								<td>
								...
								<th scope="row">브라인#2 가동시간 ON/OFF</th>
								<td>
								...
								<th scope="row">브라인#3 가동시간 ON/OFF</th>
								<td>
			...
			<dl>
				...
				<dd>
					...
					<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">냉수#1 가동시간 ON/OFF</th>
								<td>
									<select id="hex1_accum_heat_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#2 가동시간 ON/OFF</th>
								<td>
									<select id="hex2_accum_heat_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#3 가동시간 ON/OFF</th>
								<td>
									<select id="hex3_accum_heat_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
			...
			<dd>
				...
				<colgroup>
					...
					<tbody>
						...
						<tr>
							<th scope="row"><a href="#" class="font_green underline">적산월량</a></th>
