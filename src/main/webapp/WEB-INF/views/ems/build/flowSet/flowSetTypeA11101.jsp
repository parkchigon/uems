...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="chw">
		...
		<span class="pipe_chw_lr left pipe003 on" name="pipe3"><em></em></span>
		...
		<div class="coolpump_area">
			<strong class="text_info no1 font_yellow" id="storagetankpump_inv_frequency">12345.0 Hz</strong>
			...
			<dd>
				...
				<colgroup>
					...
					<tbody>
						...
						<tr>
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe9',1)" onmouseout="pipeChak('pipe9',0)" class="underline">배관9(좌)</a></th>
							<td>
							...
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe9',1)" onmouseout="pipeChak('pipe9',0)" class="underline">배관10(우)</a></th>
							<td>
