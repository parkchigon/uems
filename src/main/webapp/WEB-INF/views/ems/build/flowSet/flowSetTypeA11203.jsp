...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="hw">
		...
		<div class="coolingtower no1" id="cooltower">
			<div class="one_inner">
	...
	<div class="chw">
		...
		<span class="pipe_chw_ud down pipe006 on" name="pipe8"></span><!-- 테그네임이 2개임 -->
...
<div class="scroll" style="height:870px;">
	...
	<div class="data_area_inner mt10">
		<dl>
			<dt>냉각수 펌프<a href="#coolpump" class="buildLink" name="buildChak"></a></dt>
				...
				<colgroup>
					...
					<tbody>
						...
						<tr>
							...
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe8',1)" onmouseout="pipeChak('pipe8',0)" class="underline">배관8(우)</a></th>
							<td>
						...
						<tr>
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe8',1)" onmouseout="pipeChak('pipe8',0)" class="underline">배관9(좌)</a></th>
							<td>
