...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="chw">
		...
		<span class="pipe_chw_ud up pipe005 on" name="pipe4"></span><!-- 테그네임이 2개임 -->
				...
				<colgroup>
					...
					<tbody>
						...
						<tr>
							...
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe4',1)" onmouseout="pipeChak('pipe4',0)" class="underline">배관4(좌)</a></th>
							<td>
						...
						<tr>
							...
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe4',1)" onmouseout="pipeChak('pipe4',0)" class="underline">배관8(우)</a></th>
							<td>
