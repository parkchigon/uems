...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="hw">
		<span class="pipe_hw_ud up pipe001 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_ud down pipe002 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_ud down pipe003 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_ud down pipe004 on" name="pipe8"><em></em></span>
		
		<span class="pipe_hw_lr right pipe001 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_lr right pipe002 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_lr left pipe003 on" name="pipe8"><em></em></span>
		<span class="pipe_hw_lr right pipe004 on" name="pipe8"><em></em></span>
		...
		<div class="coolingtower no1" id="cooltower1">
			<div class="one_inner">
				...
				<strong class="text_info font_yellow textR" id="cooltower1_inv_frequency">12345.0 Hz</strong>
		...
		<div class="coolingtower no2" id="cooltower2">
			<div class="one_inner">
				<a href="#layerPop_type1" class="power off" name="modal">정지</a><!-- 모달팝업 -->
				<strong class="text_info font_yellow textL" id="cooltower2_inv_frequency">12345.0 Hz</strong>
				<span class="icon_direct direct"></span><!-- 자동일경우 none -->
			</div>
		</div>
	...
	<div class="chw">
		...
		<span class="pipe_chw_ud up pipe005 on" name="pipe9"></span><!-- 테그네임이 2개임 -->
		<span class="pipe_chw_ud up pipe006 on" name="pipe6"></span>
		<span class="pipe_chw_ud down pipe007 on" name="pipe6"></span>
		<span class="pipe_chw_ud up pipe008 on" name="pipe2"><em></em></span>
		<span class="pipe_chw_ud up pipe009 on" name="pipe2"><em></em></span>
		...
		<span class="pipe_chw_lr left pipe004 on" name="pipe2"><em></em></span>
		<span class="pipe_chw_lr left pipe005 on" name="pipe5"></span>
		<span class="pipe_chw_lr right pipe006 on" name="pipe3"><em></em></span>
		<span class="pipe_chw_lr right pipe007 on" name="pipe2"><em></em></span>
		<span class="pipe_chw_lr right pipe008 on" name="pipe6"></span>
		<span class="pipe_chw_lr right pipe009 on" name="pipe7"></span>
		<span class="pipe_chw_lr right pipe010 on" name="pipe2"></span>
		<span class="pipe_chw_lr left pipe011 on" name="pipe2"></span>
		<span class="pipe_chw_lr right pipe012 on" name="pipe2"></span>
	...
	<div class="glycol">
		...
		<span class="pipe_glycol_lr right pipe002 on" name="pipe1"><em></em></span>
...
<div class="scroll" style="height:870px;">
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<th scope="row"><a href="#cooltower1_inv_frequency" class="underline" name="buildChak">인버터 주파수</a></th>
							<td>
								<select id="cooltower1_inv_frequency" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
						...
						<tr>
							<th scope="row">인버터 주파수설정</th>
							<td>
								<select id="cooltower1_non_auto_output" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<th scope="row"><a href="#cooltower2_inv_frequency" class="underline" name="buildChak">인버터 주파수</a></th>
							<td>
								<select id="cooltower2_inv_frequency" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
						...
						<tr>
							<th scope="row">인버터 주파수설정</th>
							<td>
								<select id="cooltower2_non_auto_output" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
	...
	<div class="data_area_inner mt10">
		<dl>
			<dt>냉수펌프<a href="#coolwaterpump_main" class="buildLink" name="buildChak"></a></dt>
			<dd>
				<table class="data_row">
				<caption>caption</caption>
				<colgroup>
					...
					<tbody>
						<tr>
							<th scope="row">RUN</th>
							<td>
								<select id="coolwaterpump" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
							...
							<th scope="row">수동/자동</th>
							<td>
								<select id="coolwaterpump_auto_yn" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
						...
						<tr>
							...
							<th scope="row">기동/정지</th>
							<td>
								<select id="coolwaterpump_run_yn" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
