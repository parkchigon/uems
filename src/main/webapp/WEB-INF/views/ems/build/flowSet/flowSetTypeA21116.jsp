...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="hw">
		...
		<div class="coolingtower no1" id="cooltower_main">
			<div class="one_inner">
				...
				<strong class="text_info font_yellow textR" id="cooltower_main_inv_frequency"><span></span>12345Hz</strong>
		...
		<div class="coolingtower no2" id="cooltower_pre">
			<div class="one_inner">
				<a href="#" class="power off">정지</a><!-- 모달팝업 -->
				<strong class="text_info font_yellow textL" id="cooltower_pre_inv_frequency"><span></span>12345Hz</strong>
				<span class="icon_direct auto"></span><!-- 자동일경우 none -->
			</div>
		</div>
	...
	<div class="chw">
		...
		<div class="coolpump_area">
			<strong class="text_info no3 font_yellow" id="icestoragepump_inv_frequency"><span></span>123Hz</strong>
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<th scope="row"><a href="#cooltower_main_inv_frequency" class="underline" name="buildChak">인버터 주파수</a></th>
							<td>
								<select id="cooltower_main_inv_frequency" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<th scope="row"><a href="#cooltower_pre_inv_frequency" class="underline" name="buildChak">인버터 주파수</a></th>
							<td>
								<select id="cooltower_pre_inv_frequency" name="tagList" style="width: 100%">
									<option value="" selected="selected" >TagID</option>
									<c:forEach var="result" items="${tagList}" varStatus="status">
										<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
									</c:forEach>
