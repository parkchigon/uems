...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="hw">
		<span class="pipe_hw_ud up pipe001 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_ud down pipe002 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_ud down pipe003 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_ud down pipe004 on" name="pipe9"><em></em></span>
		
		<span class="pipe_hw_lr right pipe001 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_lr right pipe002 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_lr left pipe003 on" name="pipe9"><em></em></span>
		<span class="pipe_hw_lr right pipe004 on" name="pipe9"><em></em></span>
		...
		<div class="coolingtower no1" id="cooltower_main">
			<div class="one_inner">
				...
				<a href="#layerPop_type9" class="choice on" name="modal">선택중</a>
		...
		<div class="coolingtower no2" id="cooltower_pre">
			<div class="one_inner">
				<a href="#layerPop_type1" class="power off" name="modal">정지</a><!-- 모달팝업 -->
				<a href="#layerPop_type9" class="choice" name="modal">미선택</a>
				<span class="icon_direct direct"></span><!-- 자동일경우 none -->
			</div>
		</div>
	...
	<div class="chw">
		<span class="pipe_chw_ud down pipe001 on" name="pipe4"><em></em></span>
		<span class="pipe_chw_ud up pipe002 on" name="pipe4"></span>
		<span class="pipe_chw_ud up pipe003 on" name="pipe6"></span>
		<span class="pipe_chw_ud down pipe004 on" name="pipe6"></span>
		<span class="pipe_chw_ud up pipe005 on" name="pipe10"></span><!-- 테그네임이 2개임 -->
		<span class="pipe_chw_ud up pipe006 on" name="pipe7"></span>
		<span class="pipe_chw_ud down pipe007 on" name="pipe7"></span>
		<span class="pipe_chw_ud up pipe008 on" name="pipe12"><em></em></span>
		<span class="pipe_chw_ud up pipe009 on" name="pipe12"><em></em></span>
		
		<span class="pipe_chw_lr left pipe001 on" name="pipe4"></span>
		<span class="pipe_chw_lr left pipe002 on" name="pipe5"></span>
		<span class="pipe_chw_lr left pipe003 on" name="pipe4"><em></em></span>
		<span class="pipe_chw_lr left pipe004 on" name="pipe12"><em></em></span>
		<span class="pipe_chw_lr left pipe005 on" name="pipe6"></span>
		<span class="pipe_chw_lr right pipe006 on" name="pipe4"><em></em></span>
		<span class="pipe_chw_lr right pipe007 on" name="pipe12"><em></em></span>
		<span class="pipe_chw_lr right pipe008 on" name="pipe7"></span>
		<span class="pipe_chw_lr right pipe009 on" name="pipe8"></span>
		<span class="pipe_chw_lr right pipe010 on" name="pipe12"></span>
		<span class="pipe_chw_lr left pipe011 on" name="pipe12"></span>
		<span class="pipe_chw_lr right pipe012 on" name="pipe12"></span>
		...
		<span class="sensor_l_temperature sensor001"><em class="font_sky" id="icestorage_out_temp">12345 ℃</em></span>
		<span class="sensor_l_temperature sensor002"><em class="font_sky" id="icestorage_in_temp">12345 ℃</em></span>
		
		<div class="symbol No1" id="radiant_heat_inspect_flux"><em>유량:158 ㎡/h</em></div>
		<div class="symbol No2" id="heatstorage_inspect_flux"><em>유량:158 ㎡/h</em></div>
		
		<div class="vv-016k off" id="mv1">
		...
		<div class="centrifugal_area">
			<div class="centrifugal No1" id="fridge">
				...
				<span class="text no1 font_yellow" id="fridge1_compressor_volt">12345.7A</span>
				
				<a href="#layerPop_type7" class="power no2 on" name="modal">가동</a>
				<span class="icon_direct no2 direct"></span>
				<span class="text no2 font_yellow" id="fridge2_compressor_volt">12345.7A</span>
			</div>
			<strong class="text_info" id="fridge_direct">냉동기</strong>
		</div>
		...
		<div class="coolpump_area">
			<strong class="text_info no3 font_yellow" id="icestorage_inv_frequency">12345.0 Hz</strong>
	...
	<div class="glycol">
		...
		<span class="pipe_glycol_ud down pipe001 on" name="pipe1"><em></em></span>
		<span class="pipe_glycol_ud up pipe002 on" name="pipe1"><em></em></span>
		<span class="pipe_glycol_ud up pipe003 on" name="pipe2"></span>
		<span class="pipe_glycol_ud down pipe004 on" name="pipe2"></span>
		
		<span class="pipe_glycol_lr left pipe001 on" name="pipe1"><em></em></span>
		<span class="pipe_glycol_lr right pipe002 on" name="pipe3"></span>
		<span class="pipe_glycol_lr left pipe003 on" name="pipe1"></span>
		<span class="pipe_glycol_lr right pipe004 on" name="pipe1"></span>
		<span class="pipe_glycol_lr right pipe005 on" name="pipe2"></span>
		<span class="pipe_glycol_lr right pipe006 on" name="pipe1"><em></em></span>
		<span class="pipe_glycol_lr right pipe007 on" name="pipe1"></span>
				...
				<colgroup>
					...
					<tbody>
						...
						<tr>
							...
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe10',1)" onmouseout="pipeChak('pipe10',0)" class="underline">배관10(우)</a></th>
							<td>
						...
						<tr>
							<th scope="row"><a href="#" onmouseover="pipeChak('pipe10',1)" onmouseout="pipeChak('pipe10',0)" class="underline">배관11(좌)</a></th>
							<td>
