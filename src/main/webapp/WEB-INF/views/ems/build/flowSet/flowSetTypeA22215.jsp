...
<div class="blockDiagram_area typeA" style="height: 850px;">
	...
	<div class="hw">
		...
		<span class="pipe_hw_ud down pipe006 on" name="pipe01"><em></em></span>
		<span class="pipe_hw_corner_dr corner001"></span>
		<span class="pipe_hw_lr right pipe006 on" name="pipe01"><em></em></span>
		...
		<div class="coolpump_area">
			...
			<a href="#" class="pumpchoice no1" id="coolpump_select">선택</a>
		</div>
	</div>
	...
	<div class="chw">
		...
		<div class="coolpump_area">
			<strong class="text_info no3 font_yellow" id="icestoragepump_main_inv_frequency"><span></span>123Hz</strong>
			<a class="coolpump No3" href="#" id="icestoragepump_main">
				<span class="fan"></span>
				<strong class="name">#1</strong>
				<span class="icon_direct auto"></span>
			</a>
			<strong class="text_info no4 font_yellow" id="icestoragepump_pre_inv_frequency"><span></span>123Hz</strong>
	...
	<div class="glycol">
		...
		<span class="pipe_glycol_ud down pipe105 on" name="pipe63"></span><!-- 다른태그에 의해 동작 -->
		...
		<span class="pipe_glycol_ud down pipe104" name="pipe62"></span><!-- 다른태그에 의해 동작 -->
		...
		<div class="coolpump_area">
			<a class="coolpump ud no101" id="absorb_pump1">
				<span class="fan on"></span>
				<strong class="name">#1</strong>
				<!-- <span class="icon_direct direct"></span> -->
			</a>
			<a class="coolpump ud no102" id="absorb_pumpsb">
				<span class="fan on"></span>
				<strong class="name">SB</strong>
				<!-- <span class="icon_direct direct"></span> -->
			</a>
			<a class="coolpump ud no103" id="absorb_pump2">
				<span class="fan on"></span>
				<strong class="name">#2</strong>
				<!-- <span class="icon_direct direct"></span> -->
			</a>
	...
	<div class="refrigerating_machine_area">
		<div class="refrigerating_machine No1" id="absorb1">
			<strong class="name">#1</strong>
			<span class="power no1 on">정지</span>
		</div>
		<div class="refrigerating_machine No2" id="absorb2">
			<strong class="name">#2</strong>
			<span class="power no2 on">정지</span>
		</div>
