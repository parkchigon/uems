					...
					<colgroup>
						...
						<tbody>
							<tr>
								...
								<th scope="row">축냉완료(축열량강제0%)</th>
								<td>
									<select id="heatstorage_0_per" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">축냉완료(축열량강제100%)</th>
								<td>
									<select id="heatstorage_100_per" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
			...
			<dl>
				...
				<dd>
					...
					<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">냉수#1 순시열량</th>
								<td>
									<select id="coolwater1_inspect_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#1 적산열량</th>
								<td>
									<select id="coolwater1_accum_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#2 순시열량</th>
								<td>
									<select id="coolwater2_inspect_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#2 적산열량</th>
								<td>
									<select id="coolwater2_accum_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉수#3 순시열량</th>
								<td>
									<select id="coolwater3_inspect_heat" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉수#1 적산열량 리셋</th>
								<td>
									<select id="coolwater1_accum_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#2 적산열량 리셋</th>
								<td>
									<select id="coolwater2_accum_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉수#3 적산열량 리셋</th>
								<td>
									<select id="coolwater3_accum_reset" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">흡수식냉동기#1 적산 냉수열량 리셋</th>
								<td>
							...
							<tr>
								<th scope="row">흡수식냉동기#2 적산 냉수열량 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#3 적산 냉수열량 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#4 적산 냉수열량 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#5 적산 냉수열량 리셋</th>
								<td>
			...
			<dl>
				...
				<dd>
					...
					<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">브라인펌프#1 적산가동시간</th>
								<td>
									<select id="brinepump1_accum_hour" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">브라인펌프#1 적산가동분</th>
								<td>
									<select id="brinepump1_accum_min" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">브라인펌프#2 적산가동시간</th>
								<td>
									<select id="brinepump2_accum_hour" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">브라인펌프#2 적산가동분</th>
								<td>
									<select id="brinepump2_accum_min" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">브라인펌프#3 적산가동시간</th>
								<td>
									<select id="brinepump3_accum_hour" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">브라인펌프#3 적산가동분</th>
								<td>
									<select id="brinepump3_accum_min" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">브라인펌프#1 적산 가동시간 리셋</th>
								<td>
								...
								<th scope="row">브라인펌프#2 적산 가동시간 리셋</th>
								<td>
								...
								<th scope="row">브라인펌프#3 적산 가동시간 리셋</th>
								<td>
							...
							<tr>
								...
								<th scope="row">흡수식냉동기#1 적산 가동시간 리셋</th>
								<td>
							...
							<tr>
								<th scope="row">흡수식냉동기#2 적산 가동시간 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#3 적산 가동시간 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#4 적산 가동시간 리셋</th>
								<td>
								...
								<th scope="row">흡수식냉동기#5 적산 가동시간 리셋</th>
								<td>
			...
			<dl>
				...
				<dd>
					...
					<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">냉각탑#1-1 주간 기동온도</th>
								<td>
									<select id="cooltower1_1_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-1 주간 정지온도</th>
								<td>
									<select id="cooltower1_1_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-2 주간 기동온도</th>
								<td>
									<select id="cooltower1_2_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-2 주간 정지온도</th>
								<td>
									<select id="cooltower1_2_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉각탑#2-1 주간 기동온도</th>
								<td>
									<select id="cooltower2_1_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-1 주간 정지온도</th>
								<td>
									<select id="cooltower2_1_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-2 주간 기동온도</th>
								<td>
									<select id="cooltower2_2_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-2 주간 정지온도</th>
								<td>
									<select id="cooltower2_2_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉각탑#3-1 주간 기동온도</th>
								<td>
									<select id="cooltower3_1_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-1 주간 정지온도</th>
								<td>
									<select id="cooltower3_1_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-2 주간 기동온도</th>
								<td>
									<select id="cooltower3_2_day_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-2 주간 정지온도</th>
								<td>
									<select id="cooltower3_2_day_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉각탑#1-1 야간 기동온도</th>
								<td>
									<select id="cooltower1_1_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-1 야간 정지온도</th>
								<td>
									<select id="cooltower1_1_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-2 야간 기동온도</th>
								<td>
									<select id="cooltower1_2_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#1-2 야간 정지온도</th>
								<td>
									<select id="cooltower1_2_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉각탑#2-1 야간 기동온도</th>
								<td>
									<select id="cooltower2_1_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-1 야간 정지온도</th>
								<td>
									<select id="cooltower2_1_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-2 야간 기동온도</th>
								<td>
									<select id="cooltower2_2_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#2-2 야간 정지온도</th>
								<td>
									<select id="cooltower2_2_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
							...
							<tr>
								<th scope="row">냉각탑#3-1 야간 기동온도</th>
								<td>
									<select id="cooltower3_1_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-1 야간 정지온도</th>
								<td>
									<select id="cooltower3_1_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-2 야간 기동온도</th>
								<td>
									<select id="cooltower3_2_night_run_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
								...
								<th scope="row">냉각탑#3-2 야간 정지온도</th>
								<td>
									<select id="cooltower3_2_night_stop_temp" name="tagList" style="width: 100%">
										<option value="" selected="selected" >TagID</option>
										<c:forEach var="result" items="${tagList}" varStatus="status">
											<option value="${result.tagId}">[${result.tagId}] ${result.tagDesc}</option>
										</c:forEach>
			...
			<dd>
				<ul class="right_style">
					<li>
						...
						<a class="font_purple setPop">0.0</a> <span class="font_yellow">℃</span></a>
					</li>
					<li>
						<span class="tit">축냉종료 시간설정</span>
						<a class="font_purple setPop">0</a> <span class="font_yellow">분</span></a>
					</li>
					<li>
						<span class="tit"><a href="#layerPop_type6" name="modal">축냉완료</a></span>
						<span class="lamp off"></span>
						해지
					</li>
					<li>
						<span class="tit">방냉종료 설정온도</span>
						<a class="font_purple setPop">0.0</a> <span class="font_yellow">℃</span>
					</li>
				</ul>
			</dd>
		</dl>
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<th scope="row">브라인 펌프#1 가동시간</th>
							<td class="font_yellow">0시 0분</td>
						</tr>
						<tr>
							<th scope="row">누적 냉수#1 열량</th>
							<td class="font_yellow">0 USRT-hr</td>
						...
						<tr>
							...
							<th scope="row">냉동기#1 가동시간</th>
							<td class="font_yellow">0000시 00분</td>
						</tr>
					</tbody>
				</table>
			</dd>
		...
		<dl>
			<dt>설정 관리
				<div class="head_right">
					<a href="#" class="btn_blue">야간설정</a>
					<a href="#" class="btn_red">주간설정</a>
				</div>
			</dt>
			<dd>
				<table class="data_row">
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<td><a class="font_purple setPop">100.0</a> <span class="font_yellow">℃</span></td>
							<th scope="row">냉각탑 2-1 기동</th>
							<td><a class="font_purple setPop">0.0</a> <span class="font_yellow">℃</span></td>
		...
		<dl>
			...
			<dd>
				...
				<colgroup>
					...
					<tbody class="warning">
						<tr>
							<td class=""><a href="#">냉수펌프 #1 이상</a></td>
							<td class=""><a href="#">냉수펌프 #2 이상</a></td>
