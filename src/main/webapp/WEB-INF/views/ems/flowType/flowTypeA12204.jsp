...
<div class="blockDiagram_area typeA">
	...
	<div class="hw">
		...
		<div class="coolingtower">
			<div class="one_inner">
				<a href="javascript:openLayerPop('#layerPop_type1', 'A12204', 'cooltower');" class="power off" id="A12204_cooltower">정지</a><!-- 모달팝업 -->
				<span class="icon_direct auto"  id="A12204_cooltower_auto_yn"></span><!-- 자동일경우 none -->
			</div>
	...
	<div class="chw">
		...
		<div class="vv-016k No1 " id="mv3_class">
			<a href="javascript:openLayerPop('#layerPop_type11', 'A12204', 'mv3');" class="power" id="A12204_mv3">닫힘</a>
		...
		<div class="vv-016k left No2 " id="mv4_class">
			<a href="javascript:openLayerPop('#layerPop_type11', 'A12204', 'mv4');" class="power" id="A12204_mv4">닫힘</a>
		...
		<div class="vv-016k left No3" id="mv5_class">
			<a href="javascript:openLayerPop('#layerPop_type11', 'A12204', 'mv5');" class="power" id="A12204_mv5">닫힘</a>
			<strong class="name">MV5</strong>
			<span class="icon_direct auto" id="A12204_mv5_auto_yn"></span>
		</div>
		
		<div class="vv-016k No4" id="mv6_class">
			<a href="javascript:openLayerPop('#layerPop_type11', 'A12204', 'mv6');" class="power" id="A12204_mv6">닫힘</a>
		...
		<div class="heat_storaging_tank">
			...
			<strong class="text2 up" id="A12204_storagetank_charge_state">축냉시</strong>
			<strong class="text2 down" id="A12204_storagetank_release_state">방냉시</strong>
		</div>
		
		<div class="centrifugal_area">
			<div class="centrifugal No1">
				<a href="javascript:openLayerPop('#layerPop_type7', 'A12204', 'fridge1');" class="power no1" id="A12204_fridge1">가동</a>
				...
				<a href="javascript:openLayerPop('#layerPop_type7', 'A12204', 'fridge2');" class="power no2" id="A12204_fridge2">가동</a>
