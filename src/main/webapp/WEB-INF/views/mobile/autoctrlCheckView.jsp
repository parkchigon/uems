	...
	<div class="popup_content">
		...
		<colgroup>
			...
			<tbody>
				...
				<tr>
					<th>구성</th>
					<td colspan="2">${DETAIL_INFO.component} </td>
				</tr>
			</tbody>
		</table>
		<table class="data_row mt20">
		...
		<colgroup>
			...
			<thead>
				<tr>
					<th colspan="3">컨트롤 및 터치스크린</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<th>메이커</th>
					<td colspan="2">${DETAIL_INFO.ctrlMaker}</td>
				</tr>
				<tr>
					<th>인터넷</th>
					<td colspan="2">${DETAIL_INFO.ctrlInternet} </td>
				</tr>
			</tbody>
		</table>
		<table class="data_row mt20">
		...
		<colgroup>
			...
			<thead>
				<tr>
					<th colspan="3">PC-본체</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<th>메이커</th>
					<td colspan="2">${DETAIL_INFO.pcMaker}</td>
				</tr>
				<tr>
					<th>모델명</th>
					<td colspan="2">${DETAIL_INFO.pcModel} </td>
				</tr>
			</tbody>
		</table>
		<table class="data_row mt20">
		...
		<colgroup>
			...
			<thead>
				<tr>
					<th colspan="3">PC-모니터</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<th>메이커</th>
					<td colspan="2">${DETAIL_INFO.monMaker}</td>
				</tr>
				<tr>
					<th>모델명</th>
					<td colspan="2">${DETAIL_INFO.monModel} </td>
				</tr>
			</tbody>
		</table>
	</div>
