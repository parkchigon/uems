...
<script type="text/javaScript">
	...
	<dl id="template_${siteCd}">
		...
		<dd>
			...
			<div class="mini_view_inner type1">
				...
				<div class="machine no01">
					<span class="" id="cooltower"></span>							 <!-- 정지-->	
				</div>
				
				<div class="pump_area area01">
					<span class="pump stop" name="coolpump"></span>
					<span id="" class="text_info">냉각수펌프</span>
				</div>
				...
				<div class="pump_area area02">
					<span class="pump stop" id="storagetankpump_inv_frequency" name="storagetankpump"></span>
