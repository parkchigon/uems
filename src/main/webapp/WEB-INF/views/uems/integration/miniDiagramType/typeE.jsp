...
<script type="text/javaScript">
	...
	<dl id="template_${siteCd}">
		...
		<dd>
			...
			<div class="mini_view_inner type5">
				...
				<div class="machine no01">
					<span class="" id="cooltower1_invert_frequency"></span>
					<span class="" id="cooltower1"></span>
					<span class="" id="cooltower2_invert_frequency"></span>
					<span class="" id="cooltower2"></span>
				</div>
				...
				<div class="pump_area area03">
					<span class="pump stop" id="icestorage_inv_frequency" name="icestoragepump"></span>
