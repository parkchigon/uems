...
<script type="text/javaScript">
	...
	<dl id="template_${siteCd}">
		...
		<dd>
			...
			<div class="mini_view_inner type8">
				...
				<div class="machine no02">
					<span class="">#1 <em class="stop" id="fridge1">정지</em></span>
					<span class="">#2 <em class="stop" id="fridge2">가동</em></span>
					<span class="">#3 <em class="stop" id="fridge3">정지</em></span>
				</div>
				...
				<div class="pump_area area03">
					<span class="pump stop" name="brinepump"></span>
