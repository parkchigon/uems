		...
		<div class="table_wrap">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table_list_type">
				...
				<thead>
					<tr>
						<th></th>
						<th colspan="4">MCC판넬메인</th>
						<th></th>
						<th colspan="4">냉동기부분</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<th>형식</th>
						<td colspan="4">${DETAIL_INFO.mccType}</td>
						<th>형식</th>
						<td colspan="4">${DETAIL_INFO.refrigType}</td>
					</tr>
					<tr>
						<th>메이커</th>
						<td colspan="4">${DETAIL_INFO.mccMaker}</td>
						<th>인터넷</th>
						<td colspan="4">${DETAIL_INFO.refrigInternet} </td>
					</tr>
					<tr>
						<th></th>
						<th colspan="4">인버터</th>
						<th></th>
						<th colspan="4">전력량계</th>
					</tr>
					<tr>
						<th rowspan="2">사양</th>
						<td colspan="4">방냉펌프 : ${DETAIL_INFO.inverterStorage} </td>
						<th rowspan="2">사양</th>
						<td colspan="4">심야 : ${DETAIL_INFO.wattmeterNight}</td>
					</tr>
					<tr>
						<td colspan="4">축냉펌프 : ${DETAIL_INFO.inverterRelease}</td>
						<td colspan="4">일반 : ${DETIAIL_INFO.wattmeterDay} </td>
					</tr>
					<tr>
						<th>메이커</th>
						<td colspan="4">${DETAIL_INFO.inverterMaker} </td>
						<th>메이커</th>
						<td colspan="4">${DETAIL_INFO.wattmeterMaker}</td>
					</tr>
				</tbody>
			</table>
		</div>
