			...
			<table cellpadding="0" cellspacing="0" border="0" class="table_list_type">
				...
				<tbody>
					<tr>
						...
						<td colspan="2">${DETAIL_INFO.volumnBi} USRt</td>
						<th>전열면적(kw)</th>
					...
					<tr>
						<th rowspan="2">온도(℃)</th>
						<td rowspan="2" valign="middle">${DETAIL_INFO.tempCw1}</td>
						<td rowspan="2" valign="middle">${DETAIL_INFO.tempCw2}</td>
						<td rowspan="2" valign="middle">${DETAIL_INFO.tempBi1}</td>
						<td rowspan="2" valign="middle">${DETAIL_INFO.tempBi2}</td>
						<th>판두께(A)</th>
						<td colspan="4">${DETAIL_INFO.plateThickness} mm</td>
					</tr>
					<tr>
						<th>판수량</th>
						<td colspan="4">${DETAIL_INFO.plateCount} EA</td>
					</tr>
					<tr>
						<th rowspan="2">유량</th>
						<td rowspan="2">${DETAIL_INFO.flowCw1}</td>
						<td rowspan="2">${DETAIL_INFO.flowCw2}</td>
						<td rowspan="2">${DETAIL_INFO.flowBi1}</td>
						<td rowspan="2">${DETAIL_INFO.flowBi2}</td>
						<th>판재질(A)</th>
						<td colspan="4">${DETAIL_INFO.plateMaterial}</td>
					</tr>
					<tr>
						<th>판타입</th>
						<td colspan="4">${DETAIL_INFO.plateType} S</td>
					</tr>
					<tr>
						<th>유체</th>
						...
						<th>LMTD</th>
						<td colspan="4">${DETAIL_INFO.lmtd}</td>
					</tr>
					<tr>
						<th>손실수두</th>
						...
						<th>가스켓재질</th>
						<td colspan="4">${DETAIL_INFO.gasket}</td>
					</tr>
					<tr>
						<th>중량</th>
						<td colspan="2">${DETAIL_INFO.weightCwName}</td>
						<td colspan="2">${DETAIL_INFO.weightCwVol}</td>
						<th>크 기</th>
