		...
		<div class="table_wrap">
			<table cellpadding="0" cellspacing="0" border="0" class="table_list_type">
				...
				<tbody>
					...
					<tr>
						...
						<th>타입</th>
						<td colspan="1">${DETAIL_INFO.type}</td>
					</tr>
					<tr>
						<th>업체명</th>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table_list_type">
				...
				<tbody>
					<tr>
						<th>피크부하</th>
						<td colspan="4">${DETAIL_INFO.peakLoad} USRt</td>
						<th>관재질</th>
						<td colspan="4">${DETAIL_INFO.pipeMaterial}</td>
					</tr>
					<tr>
						<th>축열조용량</th>
						<td colspan="4">${DETAIL_INFO.volumn} USRt-hr</td>
						<th>관경</th>
						<td colspan="2">축냉 ${DETAIL_INFO.pipeDiamStorage} A</td>
						<td colspan="2">방냉 ${DETAIL_INFO.pipeDiamRelease} A</td>
					</tr>
					<tr>
						<th>축열율</th>
						<td colspan="4">${DETAIL_INFO.rate}</td>
						<th rowspan="2">자동밸브사양</th>
						<td colspan="4">${DETAIL_INFO.valve1Name} ${DETAIL_INFO.valve11} ${DETAIL_INFO.valve12}A ${DETAIL_INFO.valve13}EA</td>
					</tr>
					<tr>
						<th>크기</th>
						<td colspan="4">${DETAIL_INFO.sizeW}(W) X ${DETAIL_INFO.sizeL}(L) X ${DETAIL_INFO.sizeH}(H)</td>
						<td colspan="4">${DETAIL_INFO.valve2Name} ${DETAIL_INFO.valve21} ${DETAIL_INFO.valve22}A ${DETAIL_INFO.valve23}EA</td>
					</tr>
					<tr>
						<th>캡슐수량</th>
						<td colspan="4">${DETAIL_INFO.capsuleAmt} EA</td>
						<th rowspan="2">유량계사양</th>
						<td colspan="4">${DETAIL_INFO.current1Name} ${DETAIL_INFO.current11}A ${DETAIL_INFO.current12}EA </td>
					</tr>
					<tr>
						<th>유체</th>
						<td colspan="4">${DETAIL_INFO.fluid}</td>
						<td colspan="4">${DETAIL_INFO.current2Name} ${DETAIL_INFO.current21}A ${DETAIL_INFO.current22}EA </td>
					</tr>
					<tr>
						<th>브라인량</th>
						<td colspan="4">${DETAIL_INFO.brineAmt1} ton / ${DETAIL_INFO.brineAmt2} %</td>
						<th></th>
						<td colspan="4"></td>
					</tr>
				</tbody>
									...
									<c:choose>
										...
										<c:when test="${answer.checkTypeFlag eq 'E' }">
											...
											<c:if test="${question.designedCode eq '01' }">
												<img src="/resources/uems/images/heatstg_regularCheck.png" alt="축열조그래프" width="400" height="350"/>
											</c:if>
											<li> 
