$(document).ready(function(){
	...
	$('#wrap_area').css('height', wrapH);
	$('#content_area').css('height', wrapH-40);
});
...
function switchOn(){
	...
	$('.switch.on').find('.stop').hide();
	$('.switch.off').find('.start').hide();
	
	$dataSwitch.click(function(){
...
function buildChak(){
	$('[name=buildChak]').hover(
		...
		function(e){
			e.preventDefault();
			$('.blockDiagram_area').find('.focus').removeClass('focus');
		}
	);
	/*
	$('[name=pipeChak]').hover(
		function(e){
			e.preventDefault();
			var pipeName = $(this).attr('href');
			$('[name=' + pipeName + ']').addClass('active');
		},
		function(e){
			e.preventDefault();
			$('.blockDiagram_area').find('.active').removeClass('active');
		}
	);
	*/
};

function pipeChak(nome, action) {
	if (action==0)
	{
		$('.blockDiagram_area').find('.focus').removeClass('focus');
	}
